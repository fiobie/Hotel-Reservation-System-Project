    ...
    <div class="main-content">
        <div class="dashboard">
            <div class="dashboard-header glass-card">
                ...
                <div class="dashboard-subtitle">Welcome! Here are your latest stats and inventory overview.</div>
            </div>
            <div class="dashboard-cards">
                <a class="stat-link" href="#" aria-label="New Booking">
                    <div class="stat-card glass-card">
                        <div class="stat-icon"><i class="fas fa-calendar-check"></i></div>
                        <div class="stat-label">New Booking</div>
                        <div class="stat-value" id="stat-newBooking"><?php echo $newBooking; ?></div>
                    </div>
                </a>
                <a class="stat-link" href="#" aria-label="Available Room">
                    <div class="stat-card glass-card">
                        <div class="stat-icon"><i class="fas fa-bed"></i></div>
                        <div class="stat-label">Available Room</div>
                        <div class="stat-value" id="stat-availableRoom"><?php echo $availableRoom; ?></div>
                    </div>
                </a>
                <a class="stat-link" href="#" aria-label="Check In">
                    <div class="stat-card glass-card">
                        <div class="stat-icon"><i class="fas fa-door-open"></i></div>
                        <div class="stat-label">Check In</div>
                        <div class="stat-value" id="stat-checkIn"><?php echo $checkIn; ?></div>
                    </div>
                </a>
                <a class="stat-link" href="#" aria-label="Check Out">
                    <div class="stat-card glass-card">
                        <div class="stat-icon"><i class="fas fa-door-closed"></i></div>
                        <div class="stat-label">Check Out</div>
                        <div class="stat-value" id="stat-checkOut"><?php echo $checkOut; ?></div>
                    </div>
                </a>
                <a class="stat-link" href="#" aria-label="Reservation">
                    <div class="stat-card glass-card">
                        <div class="stat-icon"><i class="fas fa-calendar-alt"></i></div>
                        <div class="stat-label">Reservation</div>
                        <div class="stat-value" id="stat-reservation"><?php echo $reservation; ?></div>
                    </div>
                </a>
                <div class="inventory-card glass-card">
                    ...
                    <div class="inventory-table-modern">
                        ...
                        <div class="inventory-row">
                            ...
                            <span class="inventory-value badge-green"><?php echo $inventoryStats['Toiletries']; ?></span>
                        </div>
                        <div class="inventory-row">
                            <span class="inventory-icon"><i class="fas fa-bed"></i></span>
                            <span>Amenities</span>
                            <span class="inventory-value badge-green"><?php echo $inventoryStats['Amenities']; ?></span>
                        </div>
                        <div class="inventory-row">
                            <span class="inventory-icon"><i class="fas fa-utensils"></i></span>
                            <span>Food</span>
                            <span class="inventory-value badge-green"><?php echo $inventoryStats['Food']; ?></span>
                        </div>
                    </div>
                    <a href="staff_inventory.php" class="go-inventory-btn" aria-label="Go to Inventory"><i class="fas fa-arrow-right"></i> Go to Inventory</a>
                </div>
            </div>
            <div class="dashboard-updated glass-card">
                <i class="fas fa-clock"></i> Last updated: <span id="lastUpdate"><?php echo date('Y-m-d H:i:s'); ?></span>
            </div>
        </div>
    </div>
